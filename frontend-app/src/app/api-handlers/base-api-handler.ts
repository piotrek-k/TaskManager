...
export class BaseApiHandler {
    ...
    constructor(private authService: AuthService, http: HttpClient, baseUrl: string, headers:HttpHeaders) {
        this.http = http;
    ...
    getAll<T>(): Observable<T[] | null> {
        ...
        return this.http.request("get", url_, options_).flatMap((response_ : any) => {
            return this.processGetAll<T>(response_);
        }).catch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetAll<T>(<any>response_);
                } catch (e) {
    ...
    protected processGetAll<T>(response: HttpResponseBase): Observable<T[] | null> {
